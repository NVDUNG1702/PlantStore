...
import { Cart_screen, CheckoutScreen_screen, DetailProduct, Forgot_screen, Intro_screen, OrderHistory_screen, Payment_screen, Signin_screen, Signup_screen, Splash_screen, UpdateProfile_screen } from '../screen/index.screen';
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name='updateProfile' component={UpdateProfile_screen} />
            </Stack.Navigator>
        </NavigationContainer>
    )
}
